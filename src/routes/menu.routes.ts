 ...
 */
router.post("/menu", uploadAdImages.single("samplePicture"), createMenu);
 ...
 *         description: Menu not found.
 */
router.put("/menu/:id", uploadAdImages.single("samplePicture"), updateMenu);
 ...
 */
router.post("/menu/:menuId/groceries", addGrocery);
 ...
 */
router.put("/menu/:menuId/groceries/:groceryId", updateGrocery);
 ...
 */
router.delete("/menu/:menuId/groceries/:groceryId", deleteGrocery);
