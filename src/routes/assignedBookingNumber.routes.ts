...
import {
  createAssignedBookingNumber,
  deleteAssignedBookingNumber,
  getAssignedBookingNumber,
  getAssignedBookingNumbers,
  updateAssignedBookingNumber,
} from "../controllers/assignedBookingNumber.controller";
 ...
 */
router.post("/assigned-booking-number", createAssignedBookingNumber);
 ...
 */
router.get("/assigned-booking-numbers", getAssignedBookingNumbers);
 ...
 *               $ref: '#/components/schemas/AssignedBookingNumberResponse'
 */
router.get("/assigned-booking-number/:id", getAssignedBookingNumber);
 ...
 *               $ref: '#/components/schemas/AssignedBookingNumberResponse'
 */
router.put("/assigned-booking-number/:id", updateAssignedBookingNumber);
 ...
 */
router.delete("/assigned-booking-number/:id", deleteAssignedBookingNumber);
