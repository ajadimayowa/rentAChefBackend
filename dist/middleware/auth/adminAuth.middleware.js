...
exports.requireSuperAdmin = exports.requireAdminAuth = void 0;
...
const requireSuperAdmin = (req, res, next) => {
    var _a;
    const user = req.user;
    if (((_a = user === null || user === void 0 ? void 0 : user.adminDetails) === null || _a === void 0 ? void 0 : _a.role) !== 'super_admin') {
