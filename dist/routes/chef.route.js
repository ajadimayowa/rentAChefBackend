...
router.put("/chef/update/:id", adminAuth_1.adminAuth, upload_1.default.single("chefPic"), chef_controller_1.updateChef);
// Admin only
router.post("/chef/register", adminAuth_1.adminAuth, upload_1.default.single("chefPic"), chef_controller_1.createChef);
