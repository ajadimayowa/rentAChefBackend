...
const menuTypes_controller_1 = require("../controllers/menuTypes.controller");
 ...
 */
router.post("/menu-type", menuTypes_controller_1.createMenuType);
/**
 * @swagger
 * /menu-types:
 *   get:
 ...
 */
router.get("/menu-types", menuTypes_controller_1.getMenuTypes);
/**
 * @swagger
 * /menu-type/{id}:
 *   get:
 ...
 */
router.get("/menu-type/:id", menuTypes_controller_1.getMenuType);
/**
 * @swagger
 * /menu-type/{id}:
 *   put:
 ...
 */
router.put("/menu-type/:id", menuTypes_controller_1.updateMenuType);
/**
 * @swagger
 * /menu-type/{id}:
 *   delete:
 ...
 */
router.delete("/menu-type/:id", menuTypes_controller_1.deleteMenuType);
/**
 * @swagger
 ...
 */
router.post("/menu-type/:id/menus/:menuId", menuTypes_controller_1.addMenuToMenuType);
/**
 * @swagger
 * /menu-type/{id}/menus/{menuId}:
 *   put:
 ...
 */
router.put("/menu-type/:id/menus/:menuId", menuTypes_controller_1.updateMenuOnMenuType);
/**
 * @swagger
 * /menu-type/{id}/menus/{menuId}:
 *   delete:
 ...
 */
router.delete("/menu-type/:id/menus/:menuId", menuTypes_controller_1.removeMenuFromMenuType);
