...
exports.sendPasswordChangeSuccessEmail = exports.sendUserPasswordResetOTPEmail = exports.sendLoginSuccessEmail = exports.sendEmailVerificationSuccessEmail = exports.sendLoginOtpEmail = exports.sendEmailVerificationOtp = exports.sendWelcomeEmail = void 0;
...
const sendWelcomeEmail = (creatorData) => __awaiter(void 0, void 0, void 0, function* () {
    const { firstName, email, emailVerificationOtp, verifyUrl, logoUrl, footerUrl } = creatorData;
    const templatePath = path_1.default.join(__dirname, '..', 'emailTemps', 'rentAChef', 'WelcomeEmailTemplate.hbs');
    const templateSource = fs_1.default.readFileSync(templatePath, 'utf-8');
    // Compile the Handlebars templates
    const template = handlebars_1.default.compile(templateSource);
    const html = template({ firstName, email, emailVerificationOtp, verifyUrl, orgPrimaryColor: '#ffffff' });
    const subject = 'Welcome to RentAChef — verify your email';
    const remoteImages = [
        {
            url: logoUrl || 'https://rentachefdev.s3.eu-north-1.amazonaws.com/assets/chefLogo.png',
            cid: 'logo',
...
const sendLoginSuccessEmail = (creatorData) => __awaiter(void 0, void 0, void 0, function* () {
    const { firstName, email, logoUrl, footerUrl } = creatorData;
    const templatePath = path_1.default.join(__dirname, '..', 'emailTemps', 'rentAChef', 'LoginSuccessEmailTemplate.hbs');
    const templateSource = fs_1.default.readFileSync(templatePath, 'utf-8');
    // Compile the Handlebars templates
    const template = handlebars_1.default.compile(templateSource);
    const html = template({ firstName, email, orgPrimaryColor: '#ffffff' });
